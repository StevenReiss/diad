...
public class DiadLocation implements DiadConstants
{
...
protected DiadLocation(File f,int start,int end,int line,String proj,String method,double pri)
{
   for_file = f;
   start_offset = start;
   end_offset = end;
...
public int getLineNumber()
{
   ...
   if (line_number <= 0) {
      synchronized (DiadLocation.class) {
...
}       // end of class DiadLocation




/* end of DiadLocation.java */
